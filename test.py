...
print("-")
print(cubiomes.mcStepSeed(0, 0))
print(cubiomes.mcFirstInt(0, 1))
print(cubiomes.mcFirstIsZero(0, 1))
print(cubiomes.getChunkSeed(0, 0, 0))
print(cubiomes.getLayerSeed(0))
print(cubiomes.getStartSalt(0, 0))
print(cubiomes.getStartSeed(0, 0))

seed = cubiomes.JavaRndSeed(0)

print(cubiomes.setSeed(seed))
print(cubiomes.next(seed, 0))
print(cubiomes.nextInt(seed, 0))
print(cubiomes.nextLong(seed))
print(cubiomes.nextFloat(seed))
print(cubiomes.nextDouble(seed))
print(cubiomes.skipNextN(seed, 0))
print(cubiomes.invSeed48(seed))
print(cubiomes.mulInv(0, 0))
