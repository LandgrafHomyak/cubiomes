...
def getBiomeType(id: Union[int, Biome, BiomeID], /) -> Optional[BiomeType]: ...


def biomeExists(id: Union[int, Biome, BiomeID], /) -> bool: ...


def getTempCategory(id: Union[int, Biome, BiomeID], /) -> Optional[BiomeTempCategory]: ...


def areSimilar112(id1: Union[int, Biome, BiomeID], id2: Union[int, Biome, BiomeID], /) -> bool: ...


def areSimilar(id1: Union[int, Biome, BiomeID], id2: Union[int, Biome, BiomeID], /) -> bool: ...


def isShallowOcean(id: Union[int, Biome, BiomeID], /) -> bool: ...


def isDeepOcean(id: Union[int, Biome, BiomeID], /) -> bool: ...


def isOceanic(id: Union[int, Biome, BiomeID], /) -> bool: ...


def isBiomeSnowy(id: Union[int, Biome, BiomeID], /) -> bool: ...


def mcStepSeed(s: int, salt: int, /) -> int: ...


def mcFirstInt(s: int, mod: int, /) -> int: ...


def mcFirstIsZero(s: int, mod: int, /) -> int: ...


def getChunkSeed(ss: int, x: int, z: int) -> int: ...


def getLayerSeed(salt: int, /) -> int: ...


def getStartSalt(ws: int, ls: int, /) -> int: ...


def getStartSeed(ws: int, ls: int, /) -> int: ...


class JavaRndSeed:
    def __new__(self, value: int, /) -> JavaRndSeed: ...
...
def setSeed(seed: JavaRndSeed, /) -> NoReturn: ...


def next(seed: JavaRndSeed, bits: int, /) -> int: ...


def nextInt(seed: JavaRndSeed, n: int) -> int: ...


def nextLong(seed: JavaRndSeed) -> int: ...


def nextFloat(seed: JavaRndSeed) -> float: ...


def nextDouble(seed: JavaRndSeed) -> float: ...


def skipNextN(seed: JavaRndSeed, n: int) -> NoReturn: ...


def invSeed48(nseed: JavaRndSeed) -> int: ...


def mulInv(s: int, m: int) -> int: ...
